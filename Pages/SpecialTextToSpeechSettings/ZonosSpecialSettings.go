...
func BuildZonosSpecialSettings() fyne.CanvasObject {
	...
	languageSetting := GetSpecialSettingFallback("tts_zonos", "language", "en-us").(string)
	...
	updateSpecialTTSSettings := func() {
		...
		UpdateSpecialTTSSettings("tts_zonos", "language", languageSelect.GetCurrentValueOptionEntry().Value)
