...
func TTSTypeOptions() []TVO {
	...
	return []TVO{{Text: "Silero", Value: "silero"}, {Text: "F5/E2", Value: "f5_e2"}, {Text: "Zonos", Value: "zonos"}, {Text: "Kokoro", Value: "kokoro"}, {Text: "Orpheus", Value: "orpheus"}, {Text: "Chatterbox", Value: "chatterbox"}, {Text: "Maya1", Value: "maya1"}, {Text: lang.L("Disabled"), Value: ""}}
}
